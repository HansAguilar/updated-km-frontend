...
function DentistPDFFile({ patient, data, tableHeaderList,authorizedPerson, time }) {
  return (
    <Document >
      <Page style={styles.body} >
        ...
        <View style={{ marginVertical: 8,gap:3 }}>
					<Text style={{ color: "#2b2b2b", fontSize: 16,textTransform:'uppercase' }}>PATIENT DENTAL RECORDS</Text>
				</View>
