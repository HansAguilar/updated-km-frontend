            ...
            <div className="text-left py-4">
              ...
              <form className=' flex flex-col '>
                ...
                <div className=' mb-2 flex flex-col gap-1 '>
                    ...
                    <input type="text" className=' px-4 py-2 border border-gray-400 rounded-md focus:outline-none focus:shadow-md ' value={search} onChange={(e)=>handleDentistSearch(e)}/>
                    <ul className=''>
                      {
                        suggestion.length > 0 && search ?
                        suggestion.map((val,idx)=>(
                          <li key={idx} className=' shadow-md px-5 py-2 hover:bg-cyan-500 hover:text-white rounded-md ' 
                          onClick={()=>{
                        ...
                        <li className=' shadow-md px-5 py-2 rounded-md '>No existing dentist</li>
                        : data.dentistId ? <></> :<></>
                      }
                    </ul>
                </div>
                ...
                <div className=' mb-2 flex flex-col gap-1 '>
                    ...
                    <input type="date" min={minDate} className=' px-4 py-2 border border-gray-400 rounded-md focus:outline-none focus:shadow-md ' onChange={(e)=>setData({...data, dateSchedule:new Date(e.target.value)})} />
                </div>
