...
function AppointmentFee() {
    ...
    return (
        ...
        <div className=' p-10 flex flex-col gap-4'>
            <button className={`${appointmentFee.status === "AVAILABLE" ? "bg-emerald-500" : "bg-red-500"} max-w-max py-4 px-3 text-white capitalize`} onClick={buttonSubmit}>{appointmentFee.status}</button>
